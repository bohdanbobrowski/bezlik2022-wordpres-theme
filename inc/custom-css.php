...
if ( !class_exists( 'Bezlik_Custom_CSS' ) ) :

	/**
	 * Bezlik_Custom_CSS 
	 */
	Class Bezlik_Custom_CSS {
		...
		public function output_css() {
			 ...
			 */
			$colors = array(
				'breadcrumbs_links' => '.bezlik-breadcrumb-trail a',
			...
			* Responsive font sizes
			 ...
			 * Fonts
			 */
			$body_font		= get_theme_mod( 'bezlik_body_font' );
			$headings_font 	= get_theme_mod( 'bezlik_headings_font' );
			...
			$css = apply_filters( 'bezlik_custom_css_output', $css );

			wp_add_inline_style( 'bezlik-style-min', $css );	
		}
		...
		public static function get_tablet_breakpoint() {
			$breakpoint = '991';
			return apply_filters( 'bezlik_tablet_breakpoint', $breakpoint );
		}
		...
		public static function get_mobile_breakpoint() {
			$breakpoint = '575';
			return apply_filters( 'bezlik_mobile_breakpoint', $breakpoint );
		}			
	 ...
	 * Initialize class
	 */
	Bezlik_Custom_CSS::get_instance();
