...
(function($, window, document, undefined){
    ...
    $(function(){
        ...
        $('.bezlik-install-now').on( 'click', function( event ) {
            ...
            function buttonStatusInProgress( message ){
                $button.addClass('updating-message').removeClass('button-disabled bezlik-pi-not-installed installed').text( message );
            }
            ...
            function buttonStatusDisabled( message ){
                $button.removeClass('updating-message bezlik-pi-not-installed installed')
            ...
            function buttonStatusInstalled( message ){
                $button.removeClass('updating-message bezlik-pi-not-installed')
                        .addClass('installed')
                        .text( message );
            }
