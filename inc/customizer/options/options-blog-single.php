...
$wp_customize->add_section(
	'bezlik_section_blog_singles',
	array(
		'title'         => esc_html__( 'Single posts', 'bezlik'),
		'priority'      => 11,
...
$wp_customize->add_control( new Bezlik_Tabs( $wp_customize, 'blog_single_tabs',
	array(
		'linked'			=> 'blog_single_tabs',
		'label'    		=> esc_html__( 'Settings', 'bezlik' ),
		'label2'    	=> esc_html__( 'Styling', 'bezlik' ),
		'connected'		=> 'bezlik_section_blog_singles',
		'connected2'	=> 'bezlik_section_blog_singles_styling',
		'section'  		=> 'bezlik_section_blog_singles',
	)
) );
...
$wp_customize->add_control(
	new Bezlik_Radio_Images(
		...
		'single_post_layout',
		array(
			'label'    		=> esc_html__( 'Post layout', 'bezlik' ),
			'section'  => 'bezlik_section_blog_singles',
			'columns'	=> 3,
			'choices'  => array(
				'no-sidebar' => array(
					'label' => esc_html__( 'No sidebar', 'bezlik' ),
					'url'   => '%s/assets/img/sidnonesingle.svg'
				),
				'sidebar-left' => array(
					'label' => esc_html__( 'Sidebar Left', 'bezlik' ),
					'url'   => '%s/assets/img/sidleftsingle.svg'
				),	
				'sidebar-right' => array(
					'label' => esc_html__( 'Sidebar Right', 'bezlik' ),
...
$wp_customize->add_control( new Bezlik_Title( $wp_customize, 'single_post_header_title',
	array(
		'label'    			=> esc_html__( 'Post header', 'bezlik' ),
		'section'  			=> 'bezlik_section_blog_singles',
	)
) );
...
$wp_customize->add_control(
	new Bezlik_Radio_Images(
		...
		array(
			...
			'choices'  => array(
				'standard' => array(
					'label' => esc_html__( 'Standard', 'bezlik' ),
					'url'   => '%s/assets/img/postheaderstandard.svg'
				),
				'overlay' => array(
					'label' => esc_html__( 'Overlay', 'bezlik' ),
					'url'   => '%s/assets/img/postheaderbanner.svg'
				),	
				'overlap' => array(
					'label' => esc_html__( 'Overlap', 'bezlik' ),
...
$wp_customize->add_control( new Bezlik_Radio_Buttons( $wp_customize, 'single_post_header_align',
	array(
		'label'   => esc_html__( 'Alignment', 'bezlik' ),
		'section' => 'bezlik_section_blog_singles',
		'columns' => 3,
		'choices' => array(
...
$wp_customize->add_control( new Bezlik_Radio_Buttons( $wp_customize, 'single_post_header_valign',
	array(
		'section' => 'bezlik_section_blog_singles',
		'columns' => 3,
		'choices' => array(
		...
		'active_callback'	=> 'bezlik_blog_post_header_overlay_container_callback'
	)
) );
...
$wp_customize->add_control( new Bezlik_Radio_Buttons( $wp_customize, 'single_post_header_container',
	array(
		'label'   => esc_html__( 'Container type', 'bezlik' ),
		'section' => 'bezlik_section_blog_singles',
		'columns' => 3,
		'choices' => array(
		...
		'active_callback'	=> 'bezlik_blog_post_header_container_callback'
	)
) );
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_header_featured',
		array(
			'label'         	=> esc_html__( 'Use featured image for header background', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
			'active_callback'	=> 'bezlik_blog_post_header_container_callback'
		)
	)
...
$wp_customize->add_control( new Bezlik_Responsive_Number( $wp_customize, 'post_header_height',
	array(
		'label' => esc_html__( 'Height', 'bezlik' ),
		'section' => 'bezlik_section_blog_singles',
		'settings'   => array (
...
$wp_customize->add_control( new Bezlik_Title( $wp_customize, 'single_post_elements_title',
	array(
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_featured',
		array(
			'label'         	=> esc_html__( 'Featured image', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_meta',
		array(
			'label'         	=> esc_html__( 'Author & post date', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_cats',
		array(
			'label'         	=> esc_html__( 'Post categories', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_tags',
		array(
			'label'         	=> esc_html__( 'Post tags', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_sharing',
		array(
			'label'         	=> esc_html__( 'Post sharing', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
			'forward'	=> array(
				'slug'		=> 'bezlik_section_single_sharing',
				'type'		=> 'section'
			)
		)
	)
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_nav',
		array(
			'label'         	=> esc_html__( 'Post navigation', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_author_box',
		array(
			'label'         	=> esc_html__( 'Author box', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_related_box',
		array(
			'label'         	=> esc_html__( 'Related posts', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
...
$wp_customize->add_control(
	new Bezlik_Toggle_Control(
		...
		'single_post_comments',
		array(
			'label'         	=> esc_html__( 'Comments', 'bezlik' ),
			'section'       	=> 'bezlik_section_blog_singles',
		)
	)
);
 ...
 */
$wp_customize->add_section(
	'bezlik_section_blog_singles_styling',
	array(
		'title'         => esc_html__( 'Single posts styling', 'bezlik'),
		'priority'      => 11,
		'panel'         => 'bezlik_panel_blog',
	)
);
...
$wp_customize->add_control( new Bezlik_Tabs( $wp_customize, 'blog_single_tabs_styling',
	array(
		'linked'		=> 'blog_single_tabs',
		'label'    		=> esc_html__( 'Settings', 'bezlik' ),
		'label2'    	=> esc_html__( 'Styling', 'bezlik' ),
		'connected'		=> 'bezlik_section_blog_singles',
		'connected2'	=> 'bezlik_section_blog_singles_styling',
		'section'  		=> 'bezlik_section_blog_singles_styling',
	)
) );
...
$wp_customize->add_control( new Bezlik_Alpha_Color( $wp_customize, 'single_post_borders_color',
	array(
		'label' 			=> esc_html__( 'Separators', 'bezlik' ),
		'section'  			=> 'bezlik_section_blog_singles_styling',
	)
) );
...
$wp_customize->add_control( new Bezlik_Alpha_Color( $wp_customize, 'single_post_overlay_color',
	array(
		'label' 			=> esc_html__( 'Banner overlay', 'bezlik' ),
		'section'  			=> 'bezlik_section_blog_singles_styling',
		'active_callback' 	=> 'bezlik_blog_post_header_overlay_container_callback'
	)
) );
...
$wp_customize->add_control( new Bezlik_Title( $wp_customize, 'blog_single_post_title',
	array(
...
$wp_customize->add_control( new Bezlik_Responsive_Number( $wp_customize, 'single_post_title_size',
	array(
...
$wp_customize->add_control( new Bezlik_Radio_Buttons( $wp_customize, 'single_post_title_transform',
	array(
...
$wp_customize->add_control( new Bezlik_Title( $wp_customize, 'blog_single_post_meta',
	array(
...
$wp_customize->add_control( new Bezlik_Responsive_Number( $wp_customize, 'single_post_meta_size',
	array(
		'label' => esc_html__( 'Font size', 'bezlik' ),
		'section' => 'bezlik_section_blog_singles_styling',
		'settings'   => array (
...
$wp_customize->add_control( new Bezlik_Radio_Buttons( $wp_customize, 'single_post_meta_transform',
	array(
		'label'   => esc_html__( 'Text transform', 'bezlik' ),
		'section' => 'bezlik_section_blog_singles_styling',
		'columns' => 4,
