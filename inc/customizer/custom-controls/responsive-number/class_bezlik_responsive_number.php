...
class Bezlik_Responsive_Number extends WP_Customize_Control {

	public $type = 'bezlik-responsive_number';
	...
	public function build_field_html( $key, $setting, $devices ) {
		...
		$this->html[] = 
		'<div class="slider-custom-control ' . $active . ' bezlik-preview-' . $devices . ' ' .  esc_attr( $has_units ) . '">
	...
	public function render_content() { ?>
		...
		<div class="bezlik-responsive-control-header">
			<span class="customize-control-title"><?php echo esc_html( $this->label ); ?></span>
			<ul class="bezlik-devices-preview">
		...
		<div class="bezlik-responsive-wrapper">
		<?php
