...
class Bezlik_Radio_Images extends WP_Customize_Control {

	/**
	 * The type of customize control being rendered.
	 */
	public $type = 'bezlik-radio-image';
	...
	public function render_content() {		
		...
		<div id="<?php echo esc_attr( "input_{$this->id}" ); ?>" class="bezlik-radio-images-control columns-<?php echo esc_attr( $this->columns ); ?>">
