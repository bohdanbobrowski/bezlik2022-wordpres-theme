...
(function ($) {
  ...
  $.each($bg_hover_options, function (option, selector) {
    wp.customize(option, function (value) {
      value.bind(function (to) {
        $('head').find('#bezlik-preview-styles-' + option).remove();
        var output = selector + ' { background-color:' + to + '!important; }';
        $('head').append('<style id="bezlik-preview-styles-' + option + '">' + output + '</style>');
      });
    });
  });
  /**
  ...
  var $color_options = (_$color_options = {
    ...
    'breadcrumbs_links': '.bezlik-breadcrumb-trail a:not(:hover)',
    'breadcrumbs_text': '.bezlik-breadcrumb-trail',
  ...
  var $fill_options = {
    'breadcrumbs_links': '.bezlik-breadcrumb-trail svg',
  ...
  $.each($fontSizes, function (option, selector) {
    $.each($devices, function (device, mediaSize) {
      wp.customize(option + '_' + device, function (value) {
        value.bind(function (to) {
          $('head').find('#bezlik-preview-styles-' + option + '_' + device).remove();
          var output = '@media ' + mediaSize + ' {' + selector + ' { font-size:' + to + 'px; } }';
          $('head').append('<style id="bezlik-preview-styles-' + option + '_' + device + '">' + output + '</style>');
        });
      });
    });
  ...
  var $paddings_tb_options = {
    'breadcrumbs_padding': '.bezlik-breadcrumb-trail',
  ...
  wp.customize('bezlik_body_font', function (value) {
    value.bind(function (to) {
      $('head').find('#bezlik-preview-google-fonts-body-css').remove();
      $('head').append('<link id="bezlik-preview-google-fonts-body-css" href="" rel="stylesheet">');
      $('#bezlik-preview-google-fonts-body-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
      $('body').css('font-family', jQuery.parseJSON(to)['font']);
      $('body').css('font-weight', jQuery.parseJSON(to)['regularweight']);
    });
  });
  wp.customize('bezlik_headings_font', function (value) {
    value.bind(function (to) {
      $('head').find('#bezlik-preview-google-fonts-headings-css').remove();
      $('head').append('<link id="bezlik-preview-google-fonts-headings-css" href="" rel="stylesheet">');
      $('#bezlik-preview-google-fonts-headings-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
  ...
  wp.customize('bezlik_menu_font', function (value) {
    value.bind(function (to) {
      $('head').find('#bezlik-preview-google-fonts-menu-css').remove();
      $('head').append('<link id="bezlik-preview-google-fonts-menu-css" href="" rel="stylesheet">');
      $('#bezlik-preview-google-fonts-menu-css').attr('href', 'https://fonts.googleapis.com/css?family=' + jQuery.parseJSON(to)['font'].replace(/ /g, '+') + ':' + jQuery.parseJSON(to)['regularweight'] + '&display=swap');
